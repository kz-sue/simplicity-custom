...
<div class="<?php echo $entry_class; ?>">
  ...
  <p class="post-meta">
    ...
    <span class="post-date"></span><span class="published"><?php the_time( get_theme_text_date_format() ) ;?></span></span>
    <?php endif; //is_create_date_visible?>

    <?php if ( is_category_visible() && //カテゴリを表示する場合
               get_the_category() ): //投稿ページの場合?>
    <span class="category" style="display: inline;"><span class="icon_folder"></span><?php the_category(', ') ?></span>
